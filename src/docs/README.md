...
- `../../README.md` - authoritative repository guide for setup, routes, governance, and runtime truth

## IACP (Agent Protocol)

- `iacp/README.md` - IACP v3 overview and discrete governance model
- `iacp/ROLE_MATRIX.md` - current role ownership and dispatch direction
- `iacp/PROTOCOL.md` - handshake semantics and status integrity
- `iacp/TEMPLATES.md` - reusable instruction/result templates
- `iacp/GATES.md` - build/verify/deploy/schema quality gates

## Detailed Documents

- `ARCHITECTURE_REFERENCE.md` - system architecture, data flow, governance controls, and commit behavior
...
- `AGENT_ORCHESTRATION_PLAN.md` - high-level orchestration pointer to IACP docs
- `WORKFLOW_FRUGAL.md` - frugal execution pointer to IACP docs
- `AGENT_TASK_TEMPLATES.md` - template pointer to IACP docs
...
- `CODE_CLEANING_DAY.md` - active cleanup-day execution board and ownership plan
- `RELEASE_HISTORY.md` - staged feature ledger from v1.0 through current release v3.9
